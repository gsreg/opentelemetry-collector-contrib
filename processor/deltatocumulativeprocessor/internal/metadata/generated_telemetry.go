...
type TelemetryBuilder struct {
	meter                        metric.Meter
	ReceiverReceivedDeltaMetrics metric.Int64Counter
...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...telemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	builder.ReceiverReceivedDeltaMetrics, err = builder.meter.Int64Counter(
		"receiver_received_delta_metrics",
		metric.WithDescription("Number of delta metrics received."),
		metric.WithUnit("1"),
	)
